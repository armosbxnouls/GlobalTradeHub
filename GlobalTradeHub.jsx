      ...
      <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 16, width: "100%", maxWidth: 420, padding: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
            ...
            <button onClick={submit} style={{ flex: 1, padding: "10px 0", borderRadius: 10, border: "none", background: "#0F1B2D", color: "#D9A441", fontWeight: 600, cursor: "pointer" }}>{t.submit}</button>
          </div>
        </div>
      </div>
    </div>
...
export default function GlobalTradeHub() {
  ...
  const handleRegister = (form) => {
    const newCompany = {
      ...
      rating: 0,
      desc: { ru: form.products, en: form.products, es: form.products, fr: form.products, zh: form.products },
      mine: true,
      address: "",
      phones: [],
      photos: [],
  ...
  const handleProfileSave = (id, updates) => {
